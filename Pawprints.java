...
public class Pawprints extends GraphicsProgram {
	...
	private void drawPawprint(double x, double y) {
		...
		//first toe implementation
		GOval firstToe = new GOval( x +FIRST_TOE_OFFSET_X,y + FIRST_TOE_OFFSET_Y,TOE_WIDTH,TOE_HEIGHT  );
		firstToe.setFilled(true);
		add(firstToe);
		
		//second toe implementation
		GOval secToe = new GOval( x+ SECOND_TOE_OFFSET_X, y +SECOND_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
		secToe.setFilled(true);
		add(secToe);
		
		//third toe implementation
